...
<div align="center">
  ...
  <br><br>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&pause=1000&color=C8A96E&center=true&vCenter=true&width=250&lines=Full-Stack+Developer;AI+%26+Data+Science;Cybersecurity">
    <source media="(prefers-color-scheme: light)" srcset="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&pause=1000&color=8B7340&center=true&vCenter=true&width=250&lines=Full-Stack+Developer;AI+%26+Data+Science;Cybersecurity">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=18&pause=1000&color=8B7340&center=true&vCenter=true&width=250&lines=Full-Stack+Developer;AI+%26+Data+Science;Cybersecurity" alt="Typing SVG" />
  </picture>
</div>

<br>

I’m a B.Tech Computer Science (Data Science) student at CMRCET, currently interning at the **Military College of Electronics and Mechanical Engineering (MCEME)**. I develop advanced training simulators for the Indian Army using AI, AR/VR. My expertise spans **full‑stack development**, **data science**, and **cybersecurity**. I build solutions that are **scalable**, **efficient**, and **secure by design**.
...
### Languages
`Python` · `TypeScript` · `JavaScript` · `Java` · `C++` · `C` · `LaTeX`

### Frontend & Frameworks
`React` · `Next.js` · `Vue.js` · `Three.js` · `React Native` · `HTML5` · `CSS3`

### Backend, Databases & Cloud
`Node.js` · `MySQL` · `Firebase` · `Google Cloud` · `Vercel` · `Render`

### DevOps & Data Tools
`Docker` · `Git` · `Postman` · `Power BI` · `Tableau` · `Data Analysis` · `Canva` · `Gradle`

### Hardware, IoT & Security
`Arduino` · `Raspberry Pi` · `ESP32` · `AutoCAD` · `MQTT` · `Cybersecurity` · `ECC` · `TLS`
...
`IoT Security` · `PKI Certificates` · `C++` · `MQTT` · `ECC` · `Patented`
...
`Next.js` · `Node.js` · `MySQL` · `210+ Users`
...
`Autonomous Drones` · `Disaster Response` · `Python` · `Computer Vision`
...
`OWASP Top 10` · `Static Analysis` · `Python` · `Security`
...
`HealthTech IoT` · `Secure by Design` · `Management`

<br>

### Tomato Sorter & TECHBOW
...
`Computer Vision` · `Robotics HRI` · `Automation` · `Agricultural Tech`
